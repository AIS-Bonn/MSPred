"""
VGG Encoder and Decoder, which map an image to a vector, and from vector to image.
These modules are meant to be used along with the LSTMs
"""
...
class decoder(nn.Module):
    def __init__(self, dim, nc=1, extra_deep=False):
        ...
        self.upc1 = nn.Sequential(
                ...
                nn.BatchNorm2d(512, track_running_stats=BN_TRACK_STATS),
                nn.LeakyReLU(0.2, inplace=True)
                )
        # 8 x 8
